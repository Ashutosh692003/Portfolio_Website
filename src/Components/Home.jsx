...
const Home = () =>{
    ...
    />
                    ...
                    <div className=" md:pt-40  bg-deepBlue bg-opacity-35 pb-20">
                                      <p className="text-white text-2xl ml-[26vw]  md:text-4xl md:ml-48 font-mullish md:mb-5">My  <span className="text-lightBlue">story</span> begin here</p> 
                                           {/*slot1*/}
      ...
      <p className="text-white font-mullish text-lg mt-5" >My journey into programming started with curiosity and has led to a growing passion for problem-solving.</p>
                       ...
                       <p className="text-white font-mullish text-lg mt-5">Well-versed in <span className="text-lightBlue">C++, JavaScript, and Java programming languages.</span></p>
