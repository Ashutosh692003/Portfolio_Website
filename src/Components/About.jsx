...
<div className="w-[100%] ml-[5vw] mr-[5vw] pt-10  md:ml-5  md:mr-0 md:w-[60%] md:pl-28 md:pt-24">
          ...
          <p className="font-mullish text-white text-3xl">Get to <span className="text-lightBlue">know me</span></p>
                        ...
                        <div className="pt-5">
                                         ...
                                         <p className="font-mullish text-white text-xl marginTop ">I am currently pursuing my <span className="text-lightBlue">Bachelor's</span> degree in <span className="text-lightBlue">Computer Science</span> from <span className="text-lightBlue">Swami Vivekanand College of Engineering ,Indore.</span> </p>
                                         <p></p>
